...
Arguments[] = {0, bendHeight, bendLocation, thickness, AirfoilLc, biplaneStagger, -biplaneGap};
Call SingleBendAirfoil;
AirfoilLoop = Results[0];

Arguments[] = {0, bendHeight, bendLocation, thickness, AirfoilLc, 0, 0};
Call SingleBendAirfoil;
...
Physical Surface("airfoil") = {ids[{6:32}]};
